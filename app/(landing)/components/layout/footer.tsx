...
const Footer = () => {
    return (
        <footer className="bg-dark-alternate  text-white mt-36">
            <div className="container mx-auto flex justify-between pt-14 pb-24">
                <div className="w-105">
                    <Image src="/images/logo-white.svg" alt="logo footer" width={187} height={44}/>
                    <p className="text-white mt-8">Engineered for endurance and designed for speed.  Experience gear that moves as fast as you do.</p>
                </div>
