...
const FileUpload = ({onFileSelect}:TfileUploadProps) => {
    ...
    return (
        ...
        className="flex flex-col justify-center items-center py-6 w-full border border-dashed border-primary bg-primary-light">
            ...
            {!file ? (
                ...
                <div className="text-center">
                    <FiImage className="text-primary mx-auto mb-4"/>
